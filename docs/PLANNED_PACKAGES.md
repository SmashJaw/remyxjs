...
#### ~~1d. `packages/remyx-core/src/index.js`~~ ✅ (190+ exports)
...
> **Note:** The listing above shows the original v0.23.4 exports. See the current `index.js` files for the full list of 190+ exports.
...
- ~~Confirm all exports resolve~~ → 190+ named exports verified via dynamic import
...
```
Step 1  → @remyxjs/core             ✅ DONE — 62 files, 190+ exports, builds clean
